...
- turning the new material window + poster generator into a broader reusable outbound asset workflow beyond the current route-aware packet organizer, draft-launch links, asset-readiness board, send-plan layer, manual launchpad, packet-distribution summary, first marketing kit, first campaign bundles, and first campaign delivery plan, without pretending Canva sync or rendered social export already exist
