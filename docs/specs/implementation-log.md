...
- Current recommended FO next target after the live accepted-action history + AI outcome tracking bridge is `outcome-informed AI ranking + safe escalation rules`, so future threads can use measured acceptance / outcome data to tune suggestion ordering before introducing heavier background automation
