...
- Current recommended FO next target after tracked sends and engagement is `lease-date reminders`, so future threads converge on the next real FO execution gap instead of jumping straight to `Offer`, `Inspection`, or AI
