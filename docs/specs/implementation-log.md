...
- `outcome-informed AI ranking + safe escalation rules` are now live on top of the FO AI bridge, so the next FO work should stay focused on explainability, workflow hardening, and safe guardrails before any heavier background automation
