...
- Project-sales templates expose `/agent/projects/templates/[templateId]/fields` for setting reusable PDF field placement before a session is created; remote and handoff signer links only complete fields that already exist on the selected templates.
