export const enUSMessages = {
  ...
  officePipeline: {
    ...
    metricOfficeNet: "Office net",
    metricOfficeSalesVolume: "Office sales volume",
    metricOfficeGross: "Office gross",
    metricMyNetIncome: "My net income",
    metricMyGrossCommission: "My gross commission",
    metricMySalesVolume: "My sales volume",
    statusOpportunity: "Opportunity",
    statusActive: "Active",
    statusPending: "Pending",
    statusClosed: "Closed",
    statusCancelled: "Cancelled",
    keyDateClosed: "closed",
    keyDateImportantDate: "important date",
    keyDateUpdated: "updated",
    unassigned: "Unassigned",
    selectedPending: "Pending",
    selectedClosed: "{month} closed",
    pendingSelectionNote:
    ...
    ownerFilterChip: "Owner filter applied",
    noTransactionsTitle:
